document.addEventListener("DOMContentLoaded", () => {
  ...
  function updateOrderTracking(data) {
    const estimatedDeliveryTimeElement = document.querySelector(
      ".card-body .col:first-child"
    );
    estimatedDeliveryTimeElement.innerHTML = `<strong>Estimated Delivery time:</strong><br>${data.pickupTime}`;

    const shippingAddressElement = document.querySelector(
      ".card-body .col:nth-child(2)"
    );
